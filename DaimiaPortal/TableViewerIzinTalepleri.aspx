                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <%if (dtM.Rows[0][0].ToString() == "1")
                                            {  %>
                                        <td>
                                            <button onclick="if (confirm('İzini Silmek istiyor musunuz?')) {location.href = 'process.aspx?p=deleteizintalep&table=<%=Function.SifreyiCoz(Request.QueryString["tb"]) %>&id=<%=dt.Rows[i]["id"] %>';  } else { }" class=" btn btn-danger"><span class="fas fa-trash"></span></button>
                                            <a href="IzinDüzenle.aspx?id=<%=dt.Rows[i]["iTKimligi"] %>">
